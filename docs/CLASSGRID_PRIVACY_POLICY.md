...
Classgrid Technologies ("Company", "We", "Us", "Our"), having its registered office at Akurdi Railway Station Road, Sector No. 26, Pradhikaran, Nigdi, Pimpri-Chinchwad, Maharashtra 411044, India, operates the website [https://classgrid.in](https://classgrid.in), its sub-domain tenant websites (*.classgrid.in), the Classgrid mobile application available on Google Play Store and Apple App Store (the "App"), and the Classgrid ERP Platform (collectively, the "Platform").

This Privacy Policy describes how Your personal information is collected, used, stored, shared, and protected when You use Our Platform. This Policy applies to all Users of the Platform, including but not limited to Students, Parents/Guardians, Faculty Members, Institutional Administrators (Org Admins), and Visitors.
...
**By using the Platform, You agree to the collection and use of information in accordance with this Privacy Policy. If You do not agree with any part of this Policy, please do not use the Platform.**

Please note that this Policy is incorporated in and forms a part of the Terms of Use available on the Platform and Additional Terms including any policies, rules, and/or regulations.

For information about how We use cookies and similar tracking technologies, please refer to Our separate **Cookie Policy** page available at [classgrid.in/legal/cookie-policy](https://classgrid.in/legal/cookie-policy).
...
|---|---|---|
| **MongoDB Atlas** | Primary ERP Database hosting | Encrypted institutional and user data |
| **Supabase (AWS S3)** | File and Media storage (images, PDFs, videos) | Uploaded media files and documents |
| **Google Cloud Platform** | API Management, OAuth, and Firebase Notifications | Authentication tokens, API usage logs |
| **Vercel** | Frontend Website and ERP hosting | Website content and visitor logs |
| **YouTube (Google)** | Video embedding on tenant websites | No user data shared — public embeds only |
| **Razorpay** | Payment processing | Fee payment transactions (card/UPI/netbanking details handled entirely by Razorpay) |
...
## 10. INSTITUTIONAL DATA AND TENANT WEBSITES
...
|---|---|---|
| **Internet** (`INTERNET`) | Required for all Platform functionality — data sync, authentication, content loading | Required |
| **Network State** (`ACCESS_NETWORK_STATE`) | To detect network availability and show offline indicators | Required |
| **Camera** (`CAMERA`) | To scan QR codes for attendance, capture profile photos, and upload assignment images | Optional — requested only when You use camera features |
| **Read/Write Storage** (`READ_EXTERNAL_STORAGE` / `WRITE_EXTERNAL_STORAGE`) | To download and save documents (PDFs, circulars, assignments) and upload files | Optional — requested only when You download or upload files |
| **Notifications** (`POST_NOTIFICATIONS`) | To receive push notifications about notices, assignments, attendance alerts, and institutional announcements | Optional — You can disable notifications in device settings |
| **Vibrate** (`VIBRATE`) | To provide haptic feedback for notifications | Required |

### 11.2 iOS Permissions

| Permission | Purpose | Required/Optional |
|---|---|---|
| **Camera** | To scan QR codes for attendance, capture profile photos | Optional |
| **Photo Library** | To select and upload images for profiles, assignments, and gallery | Optional |
| **Notifications** | To receive push notifications | Optional |
| **Face ID / Touch ID** | For biometric app lock (if enabled by User) | Optional |
...
- **Google Sign-In:** Used for secure authentication. When You sign in with Google, We receive Your name, email address, and profile picture. We use Google's OAuth 2.0 protocol and comply with Google's API Services User Data Policy. [Google Privacy Policy](https://policies.google.com/privacy)

### 12.2 Cloud Infrastructure
- **MongoDB Atlas:** Used for database hosting. All data is encrypted at rest and in transit. [MongoDB Privacy Policy](https://www.mongodb.com/legal/privacy-policy)
- **Google Cloud Platform:** Used for cloud infrastructure, computing, and authentication services. [Google Cloud Privacy Notice](https://cloud.google.com/terms/cloud-privacy-notice)
- **Vercel:** Used for hosting the marketing website and tenant websites. [Vercel Privacy Policy](https://vercel.com/legal/privacy-policy)

### 12.3 File Storage
- **Supabase:** Used for storing uploaded files including images, PDFs, documents, and short video clips. Files are stored in access-controlled storage buckets. [Supabase Privacy Policy](https://supabase.com/privacy)

### 12.4 Content Embedding
- **YouTube (Google):** Tenant websites may embed YouTube videos for gallery and lecture content. YouTube's privacy-enhanced mode is used where possible. No user tracking data is shared with YouTube beyond standard embed functionality. [YouTube Terms of Service](https://www.youtube.com/t/terms)
- **Google Maps:** Tenant websites may embed Google Maps for location display. No user data is shared with Google Maps beyond standard embed functionality. [Google Maps Terms](https://cloud.google.com/maps-platform/terms)
...
- **Firebase Cloud Messaging (FCM):** Used for sending push notifications to Android and iOS devices. Only device tokens and notification content are shared with Firebase. [Firebase Privacy](https://firebase.google.com/support/privacy)

---

## 13. GOOGLE API SERVICES AND CLOUD PLATFORM
...
## 14. AI-POWERED FEATURES AND DATA PROCESSING
...
## 15. ACCESSING, UPDATING, AND DELETING YOUR INFORMATION
...
## 16. DATA SUBJECT RIGHTS UNDER DPDP ACT 2023
...
## 18. CONFIDENTIALITY AND SECURITY MEASURES
...
## 19. USER DISCRETION AND CONSENT
...
In accordance with the Information Technology Act, 2000, the rules made thereunder, and the Digital Personal Data Protection Act, 2023, the details of the Grievance Officer are provided below:

**Name:** Nikhil Shinde
**Designation:** Grievance Officer, Classgrid Technologies
**Email:** grievance@classgrid.in
**Phone:** +91 8623947038
**Address:** Akurdi Railway Station Road, Sector No. 26, Pradhikaran, Nigdi, Pimpri-Chinchwad, Maharashtra 411044, India

**Working Hours:** Monday to Saturday, 9:00 AM to 6:00 PM IST (excluding public holidays)

The Grievance Officer shall:
- Acknowledge Your grievance within 24 hours of receipt
- Resolve Your grievance within 15 days of acknowledgment (or such extended period as may be required, with written communication to You regarding the reason for the delay)
- Provide You with a written response regarding the resolution of Your grievance

If You are unsatisfied with the resolution provided by the Grievance Officer, You may approach the Data Protection Board of India established under the DPDP Act, 2023.
...
- **Sales Email:** sales@classgrid.in
- **Phone:** +91 8623947038 / +91 8149277038
- **Website:** [https://classgrid.in](https://classgrid.in)
- **Address:** Akurdi Railway Station Road, Sector No. 26, Pradhikaran, Nigdi, Pimpri-Chinchwad, Maharashtra 411044, India

For data-related requests (access, deletion, correction, portability), please email: **privacy@classgrid.in** with the subject line "Data Request — [Your Request Type]".

---

*This Privacy Policy is an electronic record within the meaning of the Information Technology Act, 2000, and the rules made thereunder. This electronic record is generated by a computer system and does not require any physical or digital signatures.*
