...
- Mentions: \`mentions:{userId}\``;
        ...
        dynamicSystemPrompt += `\n\nCRITICAL INSTRUCTION (EXHAUSTIVE TOOL UTILIZATION & COMPLETENESS): YOU ARE STRICTLY FORBIDDEN from truncating data. If a database query returns 14 items, YOU MUST PRINT ALL 14 ITEMS. If you print 2 items and stop, you have failed. NEVER summarize lists. CRUCIAL: NEVER narrate what you are going to do. If asked to generate a PDF or send an Email, DO NOT say "I will now generate a PDF". You MUST call the 'generate_pdf' and 'send_email' tools immediately during your thought process, and only respond to the user AFTER the tools have completed and you have the CDN link. NEVER output placeholder text.`;
